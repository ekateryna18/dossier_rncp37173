...
- IF A: Execute {project-root}/_byan/workflow/simple/advanced-elicitation/workflow.xml
- IF P: Execute {project-root}/_byan/workflow/simple/party-mode/workflow.md
