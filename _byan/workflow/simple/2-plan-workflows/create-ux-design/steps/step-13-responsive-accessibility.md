...
- When 'A' selected: Read fully and follow: {project-root}/_byan/workflow/simple/advanced-elicitation/workflow.xml
- When 'P' selected: Read fully and follow: {project-root}/_byan/workflow/simple/party-mode/workflow.md
...
- Read fully and follow: {project-root}/_byan/workflow/simple/advanced-elicitation/workflow.xml with the current responsive/accessibility content
...
- Read fully and follow: {project-root}/_byan/workflow/simple/party-mode/workflow.md with the current responsive/accessibility strategy
