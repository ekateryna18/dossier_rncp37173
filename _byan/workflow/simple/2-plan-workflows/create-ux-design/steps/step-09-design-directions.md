...
- Read fully and follow: {project-root}/_byan/workflow/simple/advanced-elicitation/workflow.xml with the current design direction content
...
- Read fully and follow: {project-root}/_byan/workflow/simple/party-mode/workflow.md with the current design direction
