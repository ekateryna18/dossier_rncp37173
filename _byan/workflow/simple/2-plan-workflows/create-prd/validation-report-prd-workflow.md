...
**Workflow Being Validated:** _byan/workflow/simple/2-plan-workflows/create-prd
...
- ✅ Party-mode workflow: Exists at `{project-root}/_byan/workflow/simple/party-mode/workflow.md`
- ✅ Advanced-elicitation task: Exists at `{project-root}/_byan/workflow/simple/advanced-elicitation/workflow.xml`
