...
# Path Definitions
workflow_path: '{project-root}/_byan/workflow/simple/3-solutioning/create-epics-and-stories'
...
Epics and Stories complete. Read fully and follow: `_byan/command/bmad-help.md` with argument `Create Epics and Stories`.
