...
- Read fully and follow: {project-root}/_byan/workflow/simple/advanced-elicitation/workflow.xml with current starter analysis
...
- Read fully and follow: {project-root}/_byan/workflow/simple/party-mode/workflow.md with starter evaluation context
