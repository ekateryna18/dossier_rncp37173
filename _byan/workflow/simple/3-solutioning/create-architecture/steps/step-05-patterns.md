...
- Read fully and follow: {project-root}/_byan/workflow/simple/advanced-elicitation/workflow.xml with current patterns
...
- Read fully and follow: {project-root}/_byan/workflow/simple/party-mode/workflow.md with implementation patterns context
