...
- Read fully and follow: {project-root}/_byan/workflow/simple/advanced-elicitation/workflow.xml with current project structure
...
- Read fully and follow: {project-root}/_byan/workflow/simple/party-mode/workflow.md with project structure context
