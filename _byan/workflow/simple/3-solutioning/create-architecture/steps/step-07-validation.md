...
- Read fully and follow: {project-root}/_byan/workflow/simple/advanced-elicitation/workflow.xml with validation issues
...
- Read fully and follow: {project-root}/_byan/workflow/simple/party-mode/workflow.md with validation context
