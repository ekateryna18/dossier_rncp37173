...
- Read fully and follow: {project-root}/_byan/workflow/simple/advanced-elicitation/workflow.xml with specific decision categories
...
- Read fully and follow: {project-root}/_byan/workflow/simple/party-mode/workflow.md with architectural decisions context
