...
workflow_path: '{project-root}/_byan/workflow/simple/bmad-quick-flow/quick-dev'
...
```xml
<invoke-task>Review {diff_output} using {project-root}/_byan/command/review-adversarial-general.xml</invoke-task>
```
