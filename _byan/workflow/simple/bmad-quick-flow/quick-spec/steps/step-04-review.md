...
workflow_path: '{project-root}/_byan/workflow/simple/bmad-quick-flow/quick-spec'
...
1. **Invoke Adversarial Review Task**:
       ...
       <invoke-task>Review {finalFile} using {project-root}/_byan/command/review-adversarial-general.xml</invoke-task>
