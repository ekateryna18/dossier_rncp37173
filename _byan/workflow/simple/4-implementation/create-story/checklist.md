...
- The `{project-root}/_byan/command/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{project-root}/_byan/command/validate-workflow.xml`
