...
- [ ] Has sidecar folder
- [ ] Uses `exec:` for workflow references
- [ ] Sidecar paths use `{project-root}/_byan/memoire/{sidecar-folder}/` format
...
- [ ] Format: `{project-root}/_byan/workflow/simple/{workflow-name}/workflow.{md|yaml}`
...
**Fix:** `exec: '{project-root}/_byan/workflow/simple/create-prd/workflow.md'`
