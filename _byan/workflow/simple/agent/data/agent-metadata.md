...
**Examples:**
```yaml
id: _byan/agent/commit-poet/commit-poet.md
id: _byan/agent/journal-keeper/journal-keeper.md
id: _byan/agent/security-engineer/security-engineer.md
```
...
| What's the unique key?     | `id` - `_byan/agent/commit-message-artisan/commit-message-artisan.md` (future lookup) |
...
```yaml
id: _byan/agent/different-agent/different-agent.md
```

**Fix:** The `id` must match the filename:
```yaml
id: _byan/agent/my-agent/my-agent.md
```
