...
During BMAD INSTALLATION, sidecar folder is copied from the agent location to `{project-root}/_byan/memoire/{sidecar-folder}/`

**ALL agent YAML references MUST use:**

```yaml
{project-root}/_byan/memoire/{sidecar-folder}/{file}
```
...
# ✅ CORRECT
critical_actions:
  - "Load COMPLETE file {project-root}/_byan/memoire/journal-keeper-sidecar/memories.md"
  - "ONLY read/write files in {project-root}/_byan/memoire/journal-keeper-sidecar/"

menu:
  - action: "Update {project-root}/_byan/memoire/journal-keeper-sidecar/memories.md with insights"
```
...
agent:
  ...
  critical_actions:
    - 'Load COMPLETE file {project-root}/_byan/memoire/{sidecar-folder}/memories.md'
    - 'Load COMPLETE file {project-root}/_byan/memoire/{sidecar-folder}/instructions.md'
    - 'ONLY read/write files in {project-root}/_byan/memoire/{sidecar-folder}/'
  ...
  menu:
    ...
    - trigger: SM or fuzzy match on save
      action: 'Update {project-root}/_byan/memoire/{sidecar-folder}/memories.md with insights'
...
# Read-only knowledge
- 'Load from {project-root}/_byan/memoire/{sidecar-folder}/knowledge/ but NEVER modify'
- 'Write ONLY to {project-root}/_byan/memoire/{sidecar-folder}/memories.md'
...
- Proper `{project-root}/_byan/memoire/` path format
...
- [ ] **ALL paths use: `{project-root}/_byan/memoire/{sidecar-folder}/...`**
