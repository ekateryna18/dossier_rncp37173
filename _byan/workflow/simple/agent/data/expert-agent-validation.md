...
- [ ] **Loads sidecar memories:** `{project-root}/_byan/memoire/{sidecar-folder}/memories.md`
- [ ] **Loads sidecar instructions:** `{project-root}/_byan/memoire/{sidecar-folder}/instructions.md`
- [ ] **Restricts file access:** `ONLY read/write files in {project-root}/_byan/memoire/{sidecar-folder}/`
...
- [ ] ALL sidecar paths use: `{project-root}/_byan/memoire/{sidecar-folder}/...`
...
- [ ] References from agent YAML to sidecar use `{project-root}/_byan/memoire/` format
...
**Fix:** `{project-root}/_byan/memoire/journal-keeper-sidecar/memories.md`
