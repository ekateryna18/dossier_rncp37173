...
- trigger: CP or fuzzy match on create-prd
  exec: '{project-root}/_byan/workflow/simple/create-prd/workflow.md'
  description: '[CP] Create Product Requirements Document'

- trigger: GB or fuzzy match on brainstorm
  exec: '{project-root}/_byan/workflow/simple/brainstorming/workflow.md'
...
- trigger: TS or fuzzy match on team-standup
  exec: '{project-root}/_byan/command/team-standup.md'
...
critical_actions:
  ...
  - 'Load COMPLETE file {project-root}/_byan/memoire/journal-keeper-sidecar/instructions.md'
...
menu:
  ...
  - trigger: QC or fuzzy match on quick-capture
    action: 'Save entry to {project-root}/_byan/memoire/journal-keeper-sidecar/entries/entry-{date}.md'
...
menu:
  - trigger: WI or fuzzy match on workflow-init
    exec: '{project-root}/_byan/workflow/simple/workflow-status/workflow.md'
...
6. **Expert sidecars:** `{project-root}/_byan/memoire/{sidecar-folder}/`
