...
<critical>The workflow execution engine is governed by: {project-root}/_byan/command/workflow.xml</critical>
<critical>You MUST have already loaded and processed: {project-root}/_byan/workflow/simple/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/_byan/workflow/simple/workflow-status">
