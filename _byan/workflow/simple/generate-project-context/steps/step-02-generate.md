...
- When 'A' selected: Execute {project-root}/_byan/workflow/simple/advanced-elicitation/workflow.xml
- When 'P' selected: Execute {project-root}/_byan/workflow/simple/party-mode
